...
public class ResolutionWithVariablesTest {
  ...
  public void shouldResolveFunction2() {
    final Double result =
        evaluateVisitor.visit(new Division(new Variable(12), new Variable("div", 4)));
  ...
  public void shouldResolveFunction5() {
    final Double result =
        evaluateVisitor.visit(
            new Power(new Variable("z", 36), new Division(new Variable(1), new Variable(2))));
  ...
  public void shouldResolveFunction6() {
    final Double result =
        evaluateVisitor.visit(new Sum(new Absolute(new Variable("value", 8)), new Variable(-8)));
  ...
  public void shouldResolveFunction8() {
    final Double result =
        evaluateVisitor.visit(
            new Multiplication(new Sum(new Variable(5), new Variable("i", -2)), new Variable(8)));
