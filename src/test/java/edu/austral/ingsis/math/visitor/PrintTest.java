...
public class PrintTest {
  ...
  public void shouldPrintFunction4() {
    ...
    final String result =
        printVisitor.visit(
            new Power(
                new Parenthesis(new Division(new Variable(27), new Variable(6))), new Variable(2)));
  ...
  public void shouldPrintFunction6() {
    ...
    final String result =
        printVisitor.visit(new Substract(new Absolute(new Variable("value")), new Variable(8)));
  ...
  public void shouldPrintFunction8() {
    ...
    final String result =
        printVisitor.visit(
            new Multiplication(
                new Parenthesis(new Substract(new Variable(5), new Variable("i"))),
                new Variable(8)));
