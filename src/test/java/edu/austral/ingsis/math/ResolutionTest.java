...
public class ResolutionTest {
  ...
  public void shouldResolveSimpleFunction3() {
    final Double result = new Multiplication(new Division(new Variable(9), new Variable(2)), new Variable(3)).evaluate();
  ...
  public void shouldResolveSimpleFunction4() {
    final Double result = new Power(new Division(new Variable(27), new Variable(6)), new Variable(2)).evaluate();
  ...
  public void shouldResolveSimpleFunction5() {
    final Double result = new Power(new Variable(36), new Division(new Variable(1), new Variable(2))).evaluate();
  ...
  public void shouldResolveSimpleFunction8() {
    final Double result = new Multiplication(new Substract(new Variable(5), new Variable(5)), new Variable(8)).evaluate();
