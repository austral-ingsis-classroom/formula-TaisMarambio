...
public class PrintTest {
  ...
  public void shouldPrintFunction3() {
    ...
    final String result =
        new Multiplication(
                new Parenthesis(new Division(new Variable(9), new Variable(2))), new Variable(3))
            .print();
  ...
  public void shouldPrintFunction4() {
    ...
    final String result =
        new Power(new Parenthesis(new Division(new Variable(27), new Variable(6))), new Variable(2))
            .print();
  ...
  public void shouldPrintFunction6() {
    ...
    final String result =
        new Substract(new Absolute(new Variable("value")), new Variable(8)).print();
  ...
  public void shouldPrintFunction8() {
    ...
    final String result =
        new Multiplication(
                new Parenthesis(new Substract(new Variable(5), new Variable("i"))), new Variable(8))
            .print();
